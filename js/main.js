...
const TRANSLATIONS = {
    en: {
        // --- General UI ---
        loginTitle: "UniFix Login", 
        loginSubtitle: "University Problem Reporting System", 
        loginBtn: "Login", 
        ...
        regTitleStud: "Student Registration", 
        regSubtitleStud: "Fill all fields and verify your ID card.",
        regTitleTeach: "Teacher Registration", 
        regSubtitleTeach: "Faculty & Staff Account Creation",
        fullName: "Full Name", 
        ...
        block: "Block Number", 
        dorm: "Dorm Number",
        uploadFront: "Upload Front ID", 
        uploadBack: "Upload Back ID (Barcode)", 
        idVerifyTitle: "ID Card Verification", 
        idVerifyDesc: "1. Upload Back ID image. 2. Click Scan to verify.",
        ...
        phStudentId: "DBU...", 
        phStaffId: "DBU...",
        phUsernameStud: "stud12345", 
        phUsernameTech: "tech1234",
        phDept: "e.g. Software Eng", 
        phYear: "e.g. 3", 
        phBlock: "Block No", 
        phDorm: "Dorm No",
        ...
        deleteConfirmMsg: "Delete this report?",
        reasonDecline: "Reason", 
        reportRemoved: "Report removed from view.",
        totalReports: "Total Reports", 
        incomingPending: "Incoming Pending Reports", 
        taskProgress: "Task Progress Tracking",
        manageReports: "Manage Reports", 
        userDb: "User Database", 
        noPendingMsg: "No reports assigned to you currently.",
        filterStatus: "Filter by Status", 
        myTasks: "My Handled Tasks", 
        allTasks: "All University Tasks",
        finished: "Finished", 
        declined: "Declined",
        reporter: "Reporter", 
        ...
        sendWarning: "Send Warning ⚠️", 
        removeUser: "Remove User 🗑️",
        assignBtn: "Assign", 
        declineBtn: "Decline", 
        viewBtn: "View", 
        manageBtn: "Manage",
    ...
    am: {
        // --- General UI ---
        loginTitle: "UniFix መግቢያ", 
        loginSubtitle: "የዩኒቨርሲቲ ችግር ሪፖርት ማድረጊያ",
        loginBtn: "ግባ", 
        noAccount: "መለያ የለዎትም?",
        lblUsername: "የተጠቃሚ ስም", 
        lblPassword: "የይለፍ ቃል", 
        phUsername: "የተጠቃሚ ስም ያስገቡ", 
        ...
        // --- Registration Pages ---
        registerStudent: "እንደ ተማሪ ይመዝገቡ", 
        registerTeacher: "እንደ መምህር ይመዝገቡ", 
        registerAccount: "መለያ ይፍጠሩ",
        regTitleStud: "የተማሪ ምዝገባ", 
        regSubtitleStud: "እባክዎ ሁሉንም መረጃዎች ይሙሉ እና መታወቂያዎን ያረጋግጡ።",
        regTitleTeach: "የመምህራን ምዝገባ", 
        regSubtitleTeach: "የመምህራን እና ሰራተኞች መለያ መፍጠሪያ",
        fullName: "ሙሉ ስም", 
        ...
        block: "ብሎክ ቁጥር", 
        dorm: "ዶርም ቁጥር",
        uploadFront: "የፊት መታወቂያ ጫን", 
        uploadBack: "የኋላ መታወቂያ ጫን",
        idVerifyTitle: "መታወቂያ ማረጋገጫ", 
        idVerifyDesc: "1. የኋላ መታወቂያ ፎቶ ይጫኑ። 2. 'ስካን' የሚለውን ይጫኑ።",
        scanBtn: "የኋላ መታወቂያ ስካን",
        backToLogin: "ወደ መግቢያ ተመለስ", 
        scanning: "በመፈለግ ላይ...", 
        idMatch: "ተረጋግጧል!", 
        idMismatch: "መታወቂያው አይዛመድም!", 
        noBarcode: "ባርኮድ አልተገኘም",
        ...
        // --- Placeholders ---
        phFullName: "ሙሉ ስም ያስገቡ", 
        phStudentId: "DBU...", 
        phStaffId: "DBU...",
        phUsernameStud: "stud12345", 
        phUsernameTech: "tech1234",
        phDept: "ምሳሌ፡ Software Eng", 
        phYear: "ምሳሌ፡ 3", 
        phBlock: "ብሎክ ቁጥር", 
        phDorm: "ዶርም ቁጥር",
        ...
        idMatch: "መታወቂያው በተሳካ ሁኔታ ተረጋግጧል!",
        ...
        high: "ከፍተኛ", 
        urgent: "አስቸኳይ",
        manageReports: "ሪፖርቶችን ያስተዳድሩ", 
        userDb: "የተጠቃሚዎች መረጃ",
        noPendingMsg: "በአሁኑ ጊዜ ለእርስዎ የተመደበ ሪፖርት የለም።",
        filterStatus: "በሁኔታ አጣራ", 
        myTasks: "በእኔ የተሰሩ ስራዎች", 
        allTasks: "የዩኒቨርሲቲው አጠቃላይ ስራዎች",
        finished: "ተጠናቀዋል", 
        declined: "ውድቅ ተደርገዋል",
        reporter: "ሪፖርት አቅራቢ", 
        assignedTo: "የተመደበለት",
        ...
        warnings: "ማስጠንቀቂያ", 
        id: "መለያ",
        reportDetails: "የሪፖርት ዝርዝር", 
        userProfile: "የተጠቃሚ መረጃ",
        sendWarning: "ማስጠንቀቂያ ላክ ⚠️", 
        removeUser: "ተጠቃሚውን አስወግድ 🗑️",
        assignBtn: "መድብ", 
        declineBtn: "ሰርዝ", 
        viewBtn: "ይመልከቱ", 
        manageBtn: "አስተዳድር",
        ...
        startJob: "ስራ ጀምር", 
        finishJob: "ስራ ጨርስ",
        locationDetails: "የቦታ እና ዝርዝር መረጃ", 
        reporterInfo: "የሪፖርት አቅራቢ መረጃ",
